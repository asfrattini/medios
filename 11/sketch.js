...
function preload() {
  ...
  //Preload de los sonidos de los niveles
  musicaNivel1 = loadSound("Musica/Nivel1.mp3");
  musicaNivel2 = loadSound("Musica/Nivel2.mp3");
  musicaNivel3 = loadSound("Musica/Nivel3.mp3");

  invensible = loadSound("Musica/invensible.mp3");
  morder = loadSound("Musica/morder.mp3");
  ganar = loadSound("Musica/ganar.mp3");
}
...
function draw() {
  ...
  if (estado == 1) {
    ...
    if (timer >= 1 && timer < 500) {
      ...
      if (!invensible.isPlaying()) {
        musicaNivel1.setVolume(0.1);
        invensible.setVolume(0.2);
        invensible.play();
      }
    }
    if (timer >= 500) {
    ...
    for (var p = 0; p < numPeces; p++) {
      ...
      if (tieneGorro == false) {
        ...
        if (yvar > peces[p].y && yvar < peces[p].y + 82) {
          if (xvar > peces[p].x && xvar < peces[p].x + 275) {
            if (!morder.isPlaying()) {
              morder.play()
            }
    ...
    for (var p2 = 0; p2 < numPeces2; p2++) {
      ...
      if (tieneGorro == false) {
        if (yvar > peces2[p2].y && yvar < peces2[p2].y + 82) {
          if (xvar > peces2[p2].x && xvar < peces2[p2].x + 275) {
            if (!morder.isPlaying()) {
              morder.play()
            }
            musicaNivel2.pause()
    ...
    for (var p3 = 0; p3 < numPeces; p3++) {
      ...
      if (tieneGorro == false) {
        if (yvar > peces3[p3].y && yvar < peces3[p3].y + 82) {
          if (xvar > peces3[p3].x && xvar < peces3[p3].x + 275) {
            if (!morder.isPlaying()) {
              morder.play()
            }
